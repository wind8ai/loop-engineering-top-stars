...
> Source: [wind8ai loop-engineering list](https://github.com/stars/wind8ai/lists/loop-engineering) · Updated: 2026-08-27
...
- [superpowers](#1-obrasuperpowers-278k-) — Agentic skills framework and software development methodolog…
- [spec-kit](#5-githubspec-kit-132k-) — Toolkit to help you get started with Spec-Driven Development
...
- [gsd-core](#20-open-gsdgsd-core-88k-) — Git
...
- [comet](#27-rpamiscomet-29k-) — Resumable long-running coding workflow and skill platform co…
- [pilot-shell](#30-maxritterpilot-shell-21k-) — Spec-driven planning, enforced TDD, persistent memory, and q…
- [how-to-ralph-wiggum](#34-ghuntleyhow-to-ralph-wiggum-17k-) — Canonical Ralph Wiggum guide — idea to spec to implementatio…
- [spec-kitty](#35-priivacy-aispec-kitty-16k-) — Spec-driven development for serious software developers — Ka…
- [gsd-pi](#40-open-gsdgsd-pi-12k-) — GSD meta-prompting and spec-driven development (Pi edition) …
...
- [gsd-2](#21-gsd-buildgsd-2-78k-) — Lightweight meta-prompting and spec-driven development syste…
- [loopx](#22-huangruitengloopx-52k-) — Lightweight state kernel for long-running AI agent teams, wi…
- [cc-sdd](#23-gotalabcc-sdd-36k-) — Minimal SDD harness that turns approved specs into long-runn…
- [ralph-orchestrator](#24-mikeyobrienralph-orchestrator-31k-) — Improved Ralph Wiggum implementation for autonomous AI agent…
- [loopy](#25-forward-futureloopy-31k-) — Library and companion skill for discovering, auditing, desig…
- [ralphy](#26-michaelshimelesralphy-3k-) — Ralph Wiggum-style autonomous bash loop running Claude Code,…
- [comet](#27-rpamiscomet-29k-) — Resumable long-running coding workflow and skill platform co…
- [ralph-tui](#29-subsyralph-tui-24k-) — Terminal UI orchestrator connecting coding agents to task li…
- [agent-teams-ai](#31-777geniusagent-teams-ai-2k-) — Desktop app for autonomous multi-agent teams with task board…
- [open-ralph-wiggum](#32-th0rgalopen-ralph-wiggum-19k-) — Ralph loop CLI for OpenCode, Claude Code, and Codex — run `r…
- [zeroshot](#33-the-open-enginezeroshot-18k-) — Multi-agent orchestration CLI for autonomous software engine…
- [how-to-ralph-wiggum](#34-ghuntleyhow-to-ralph-wiggum-17k-) — Canonical Ralph Wiggum guide — idea to spec to implementatio…
- [ralphex](#37-umputunralphex-15k-) — Extended Ralph loop CLI for autonomous AI-driven plan execut…
...
- [superpowers](#1-obrasuperpowers-278k-) — Agentic skills framework and software development methodolog…
- [ECC](#2-affaan-mecc-244k-) — Agent harness performance optimization system — skills, inst…
- [skills](#3-mattpocockskills-238k-) — Matt Pocock's personal skills collection, straight from his
- [andrej-karpathy-skills](#4-multica-aiandrej-karpathy-skills-208k-) — A single CLAUDE
- [agent-skills](#7-addyosmaniagent-skills-90k-) — Production-grade engineering skills for AI coding agents
- [taste-skill](#8-leonxlnxtaste-skill-81k-) — Design taste skill that stops AI from generating boring, gen…
...
- [prime-agent](#15-primeintellect-aiprime-agent-19k-) — Prime Intellect's open-source self-improving coding and rese…
...
- [pydantic-ai](#14-pydanticpydantic-ai-20k-) — Pydantic's typed Python AI SDK and agent harness for multi-m…
- [prime-agent](#15-primeintellect-aiprime-agent-19k-) — Prime Intellect's open-source self-improving coding and rese…
- [Trellis](#17-mindfold-aitrellis-14k-) — High-performance agent harness runtime for complete agentic …
- [gsd-core](#20-open-gsdgsd-core-88k-) — Git
- [cc-sdd](#23-gotalabcc-sdd-36k-) — Minimal SDD harness that turns approved specs into long-runn…
- [advanced-context-engineering-for-coding-agents](#28-humanlayeradvanced-context-engineering-for-coding-agents-26k-) — Advanced Context Engineering (ACE) for coding agents — retri…
