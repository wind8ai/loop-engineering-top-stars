...
> 来源：[wind8ai 的 loop-engineering 列表](https://github.com/stars/wind8ai/lists/loop-engineering) · 更新：2026-08-24
...
27. [rpamis/comet (2.8k ⭐)](#27-rpamiscomet-28k-)
28. [humanlayer/advanced-context-engineering-for-coding-agents (2.5k ⭐)](#28-humanlayeradvanced-context-engineering-for-coding-agents-25k-)
29. [subsy/ralph-tui (2.4k ⭐)](#29-subsyralph-tui-24k-)
30. [maxritter/pilot-shell (2k ⭐)](#30-maxritterpilot-shell-2k-)
...
## 25. Forward-Future/loopy (3k ⭐)

**🔗** https://github.com/Forward-Future/loopy  
**🍴** Fork 275 | **🔄** Updated 2026-07-26  
...
## 33. ghuntley/how-to-ralph-wiggum (1.7k ⭐)
...
- [spec-kit](#5-githubspec-kit-131k-) — Spec-Driven Development 入门工具包，帮助开发者快速上手 spec 驱动开发方法论
...
- [gsd-core](#20-open-gsdgsd-core-86k-) — Git. Ship. Done 工作流 Harness 核心，Spec 驱动的轻量 agentic 交付闭环
...
- [comet](#27-rpamiscomet-28k-) — 可恢复的长周期 coding workflow 与 Skill 平台，把 OpenSpec、Superpowers、执行…
...
- [superpowers](#1-obrasuperpowers-277k-) — 完整的 coding agent 软件开发方法论与技能框架
...
- [loopx](#22-huangruitengloopx-51k-) — 面向长周期 AI Agent 团队的轻量状态内核，提供持久目标、配额感知自动唤醒、可执行待办、证据日志与可验证交接，兼容…
- [ralph-orchestrator](#24-mikeyobrienralph-orchestrator-31k-) — Ralph Wiggum 自主 AI agent 编排的改进实现，支持多后端与长周期任务循环直至 spec 完成
- [loopy](#25-forward-futureloopy-3k-) — 可复用 Agent Loop 目录与配套 Skill，帮助 agent 发现、审计、设计、执行和复盘带反馈的工作流
...
- [how-to-ralph-wiggum](#33-ghuntleyhow-to-ralph-wiggum-17k-) — Ralph Wiggum 方法论主文档：从 idea → spec → IMPLEMENTATION_PLAN → 自主…
- [ralphex](#37-umputunralphex-14k-) — 扩展版 Ralph 循环 CLI，面向自主 AI 驱动的 plan 执行，支持多 agent 后端与完成信号检测
...
- [ECC](#2-affaan-mecc-243k-) — Agent Harness 性能优化全栈系统，涵盖 Skills、本能、记忆、安全与研究优先开发流程，面向 Claude…
- [skills](#3-mattpocockskills-235k-) — Matt Pocock 的个人 skills 目录，直接从 .claude 目录整理，面向真正的工程师
- [andrej-karpathy-skills](#4-multica-aiandrej-karpathy-skills-206k-) — 基于 Andrej Karpathy 对 LLM 编程陷阱的观察整理的单文件 CLAUDE.md 指南，以「先思考再编码…
- [agent-skills](#7-addyosmaniagent-skills-89k-) — 生产级 AI coding agent 工程技能集合，覆盖现代工程实践关键场景
- [taste-skill](#8-leonxlnxtaste-skill-80k-) — 开源设计品味 Skill，为 AI coding agent 提供更好的布局、排版、间距与动效审美
...
- [prime-agent](#15-primeintellect-aiprime-agent-18k-) — Prime Intellect 开源的自改进 coding 与 research Agent，以 Recursive L…
...
- [pydantic-ai](#14-pydanticpydantic-ai-19k-) — Pydantic 的类型化 Python AI SDK 与 Agent Harness，统一支持多模型 Agent、实时…
- [prime-agent](#15-primeintellect-aiprime-agent-18k-) — Prime Intellect 开源的自改进 coding 与 research Agent，以 Recursive L…
- [Trellis](#17-mindfold-aitrellis-14k-) — 高性能 Agent Harness 运行时，提供完整 agentic 工作流与多工具集成，文档见 docs.trytre…
- [gsd-core](#20-open-gsdgsd-core-86k-) — Git. Ship. Done 工作流 Harness 核心，Spec 驱动的轻量 agentic 交付闭环
- [cc-sdd](#23-gotalabcc-sdd-36k-) — 将已批准 spec 转化为长周期自主实现的最小 SDD Harness，含 Agent Skills，兼容 Claude…
- [advanced-context-engineering-for-coding-agents](#28-humanlayeradvanced-context-engineering-for-coding-agents-25k-) — Advanced Context Engineering（ACE）for coding agents：长上下文窗口下的检…
- [pilot-shell](#30-maxritterpilot-shell-2k-) — 工程师向 Claude Code/Codex 工作流 Shell：Spec 规划、强制 TDD、持久记忆与多层质量门禁，…
- [agent-teams-ai](#31-777geniusagent-teams-ai-2k-) — 多 Agent 团队桌面应用，通过任务看板、Agent 间通信和交叉审查组织自主协作
- [zeroshot](#34-the-open-enginezeroshot-17k-) — 自主软件工程多 Agent 编排 CLI，将实现者与独立 verifier 分离
